...
public class MyStore extends FrameLayout implements NestedScrollingParent2 {
    ...
    public MyStore(@NonNull Context context) {
        this(context, null);
    }

    public MyStore(@NonNull Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, -1);
    }

    public MyStore(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    protected void onFinishInflate() {
        ...
        mIvAssemble = findViewById(R.id.iv_follow);
...
//        mVCollect = findViewById(R.id.iv_collect);
    ...
    private void alphaGradientByPro(float upAlphaGradientPro) {
        ...
        int topBarColor = (int) topBarArgbEvaluator.evaluate(
                ...
                getContext().getResources().getColor(R.color.color_green)
        );
